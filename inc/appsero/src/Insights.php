...
if ( ! class_exists( '\Appsero\Insights' ) ) {
	...
	class Insights {
		...
		public function handle_optin_optout() {
			...
			if ( isset( $_GET[ $this->client->slug . '_tracker_optin' ] ) && 'true' === $_GET[ $this->client->slug . '_tracker_optin' ] ) {
				$this->optin();
		...
		public function deactivate_scripts() {
			...
			$custom_reasons = apply_filters( 'appsero_custom_deactivation_reasons', array(), $this->client );
			?>
